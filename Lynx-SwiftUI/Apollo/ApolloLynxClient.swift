...
typealias OAuthLoginIds = [ApolloGeneratedGraphQL.GetProfileInformationQuery.Data.SelfLookup
  .OauthLoginId]
...
enum LeaderStat {
  ...
  case verticalDistanceStat(
    ApolloGeneratedGraphQL.GetAllLeaderboardsQuery.Data.VerticalDistanceLeader.Stats?)
  case selectedLeaderStat(
    ApolloGeneratedGraphQL.GetSpecificLeaderboardQuery.Data.Leaderboard.Stats?)
  case partyLeaderStat(
    ApolloGeneratedGraphQL.GetPartyDetailsQuery.Data.PartyLookupById.Leaderboard.Stats?)
}
...
final class ApolloLynxClient {
  ...
  static func getProfileInformation(
    completion: @escaping (Result<ProfileAttributes, Error>) -> Void
  ) {
  ...
  static func oauthSignIn(
    ...
    Logger.apollo.debug(
      "                         profilePictureUrl  -> \(profilePictureURL?.absoluteString ?? "nil")"
    )
    ...
    if let firstName = firstName, let lastName = lastName {
      ...
      if let profilePictureURL = profilePictureURL {
        userData.append(
          ApolloGeneratedGraphQL.KeyValuePair(
            key: "profilePictureUrl", value: profilePictureURL.absoluteString))
      }
    }

    apolloClient.perform(
      mutation: ApolloGeneratedGraphQL.OauthSignInMutation(
  ...
  static func refreshAccessToken(
    refreshToken: String, completion: @escaping (Result<Void, Error>) -> Void
  ) {
    apolloClient.perform(
      ...
      case .success(let graphQLResult):
        ...
        guard
          let expiryInMilliseconds = Double(data.expiryDate)
        else {
          Logger.apollo.error("Could not convert expiryDate to Double.")
  ...
  static func editUser(
    profileChanges: [String: Any], completion: @escaping ((Result<String, Error>) -> Void)
  ) {
    ...
    apolloClient.perform(mutation: ApolloGeneratedGraphQL.EditUserMutation(userData: userData)) {
      result in
      switch result {
      case .success(let graphQLResult):
  ...
  static func createUserProfilePictureUploadUrl(
    completion: @escaping ((Result<String, Error>) -> Void)
  ) {

    apolloClient.perform(
      mutation: ApolloGeneratedGraphQL.CreateUserProfilePictureUploadUrlMutation()
    ) { result in
      switch result {
      case .success(let graphQLResult):
  ...
  static func createUserRecordUploadUrl(
    filesToUpload: [String], completion: @escaping ((Result<[String], Error>) -> Void)
  ) {
    ...
    apolloClient.perform(
      mutation: ApolloGeneratedGraphQL.CreateRunRecordUploadUrlMutation(
        requestedPaths: filesToUpload)
    ) { result in
      switch result {
      case .success(let graphQLResult):
        ...
        if filesToUpload.count != urls.count {
          Logger.apollo.error(
            "The number of URL's returned does not match the number of files requested for upload.")
  ...
  static func getUploadedLogs(completion: @escaping ((Result<Set<String>, Error>) -> Void)) {
    ...
    apolloClient.fetch(query: ApolloGeneratedGraphQL.GetUploadedLogsQuery()) { result in
      ...
      case .success(let graphQLResult):
        ...
        let uploadedSlopeFiles = Set(
          logbook.map { $0.originalFileName.split(separator: "/").last.map(String.init) ?? "" })
  ...
  static func getLogs(
    measurementSystem: MeasurementSystem, completion: @escaping ((Result<Logbooks, Error>) -> Void)
  ) {
    apolloClient.fetch(query: ApolloGeneratedGraphQL.GetLogsQuery(system: .init(measurementSystem)))
    { result in
      switch result {
      case .success(let graphQLResult):
  ...
  static func deleteAccount(
    ...
    apolloClient.perform(mutation: ApolloGeneratedGraphQL.DeleteAccountMutation()) { result in
      switch result {
      case .success(let graphQLResult):
        guard graphQLResult.data?.deleteUser.id != nil else {
  ...
  static func mergeAccount(
    with account: ApolloGeneratedGraphQL.OAuthTypeCorrelationInput,
    completion: @escaping ((Result<Void, Error>) -> Void)
  ) {
    ...
    apolloClient.perform(
      mutation: ApolloGeneratedGraphQL.CombineOAuthAccountsMutation(combineWith: account)
    ) { result in

      switch result {
      case .success(let graphQLResult):
        guard graphQLResult.data?.combineOAuthAccounts.id != nil else {
  ...
  static func createParty(
    name: String, description: String? = nil,
    completion: @escaping ((Result<PartyAttributes, Error>) -> Void)
  ) {
    enum CreatePartyError: Error {
      case unwrapError
    }
    apolloClient.perform(
      mutation: ApolloGeneratedGraphQL.CreatePartyMutation(
        name: name,
  ...
  static func editParty(
    partyId: String, partyChanges: [String: String],
    completion: @escaping ((Result<EditPartyResult, Error>) -> Void)
  ) {
    enum EditPartyError: Error {
      case unwrapError
    }

    let partyData = partyChanges.map {
      ApolloGeneratedGraphQL.KeyValuePair(key: $0.key, value: $0.value)
    }

    apolloClient.perform(
      mutation: ApolloGeneratedGraphQL.EditPartyMutation(partyId: partyId, partyData: partyData)
    ) { result in
      switch result {
      case .success(let graphQLResult):
  ...
  static func deleteParty(partyId: String, completion: @escaping ((Result<Void, Error>) -> Void)) {
    ...
    apolloClient.perform(mutation: ApolloGeneratedGraphQL.DeletePartyMutation(partyId: partyId)) {
      result in
      switch result {
      case .success(let graphQLResult):
        guard graphQLResult.data?.deleteParty != nil else {
  ...
  static func joinParty(partyId: String, completion: @escaping ((Result<Void, Error>) -> Void)) {
    ...
    apolloClient.perform(mutation: ApolloGeneratedGraphQL.JoinPartyMutation(partyId: partyId)) {
      result in
      switch result {
      case .success(let graphQLResult):
        guard graphQLResult.data?.joinParty != nil else {
  ...
  static func leaveParty(partyId: String, completion: @escaping ((Result<Void, Error>) -> Void)) {
    ...
    apolloClient.perform(mutation: ApolloGeneratedGraphQL.LeavePartyMutation(partyId: partyId)) {
      result in
      switch result {
      case .success(let graphQLResult):
        guard graphQLResult.data?.leaveParty != nil else {
  ...
  static func inviteUserToParty(
    partyId: String, userId: String,
    completion: @escaping ((Result<InviteUserResult, Error>) -> Void)
  ) {
    ...
    apolloClient.perform(
      mutation: ApolloGeneratedGraphQL.CreatePartyInviteMutation(partyId: partyId, userId: userId)
    ) { result in
      switch result {
      case .success(let graphQLResult):
  ...
  static func removeInviteFromParty(
    partyId: String, userId: String,
    completion: @escaping ((Result<RemoveInviteResult, Error>) -> Void)
  ) {
    ...
    apolloClient.perform(
      mutation: ApolloGeneratedGraphQL.DeletePartyInviteMutation(partyId: partyId, userId: userId)
    ) { result in
      switch result {
      case .success(let graphQLResult):
  ...
  static func removeUserFromParty(
    partyId: String, userId: String,
    completion: @escaping ((Result<RemoveUserResult, Error>) -> Void)
  ) {
    ...
    apolloClient.perform(
      mutation: ApolloGeneratedGraphQL.RemoveUserFromPartyMutation(partyId: partyId, userId: userId)
    ) { result in
      switch result {
      case .success(let graphQLResult):
  ...
  static func userLookupByEmail(
    email: String, completion: @escaping ((Result<PartyUser?, Error>) -> Void)
  ) {
    apolloClient.fetch(query: ApolloGeneratedGraphQL.UserLookupByEmailQuery(email: email)) {
      result in
      switch result {
      case .success(let graphQLResult):
