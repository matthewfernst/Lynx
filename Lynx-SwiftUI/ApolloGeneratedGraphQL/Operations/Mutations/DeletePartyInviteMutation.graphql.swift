...
public extension ApolloGeneratedGraphQL {
  class DeletePartyInviteMutation: GraphQLMutation {
    public static let operationName: String = "DeletePartyInvite"
    public static let document: ApolloAPI.DocumentType = .notPersisted(
      definition: .init(
        #"""
        mutation DeletePartyInvite($partyId: ID!, $userId: ID!) {
          deletePartyInvite(partyId: $partyId, userId: $userId) {
            __typename
            id
            name
            invitedUsers {
    ...
    public struct Data: ApolloGeneratedGraphQL.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("deletePartyInvite", DeletePartyInvite.self, arguments: [
          "partyId": .variable("partyId"),
          "userId": .variable("userId")
        ]),
      ] }

      public var deletePartyInvite: DeletePartyInvite { __data["deletePartyInvite"] }

      /// DeletePartyInvite
      ///
      /// Parent Type: `Party`
      public struct DeletePartyInvite: ApolloGeneratedGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
