    ...
    ApolloLynxClient.getAllLeaderboards(
      ...
      DispatchQueue.main.async {
        ...
        case .success(let leaderboards):
          ...
          // Log detailed info
          Logger.leaderboard.info(
            "Successfully fetched leaderboards - Distance: \(self.distanceLeaders.count), RunCount: \(self.runCountLeaders.count), TopSpeed: \(self.topSpeedLeaders.count), Vertical: \(self.verticalDistanceLeaders.count)"
          )
