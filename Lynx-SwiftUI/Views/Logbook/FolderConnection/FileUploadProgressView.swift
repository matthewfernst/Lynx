...
struct FileUploadProgressView: View {
  ...
  private var allSetText: some View {
    VStack(spacing: 12) {
      ...
      Text(
        "Your Slopes folder is connected. Your files will be automatically uploaded when you open the app."
      )
  ...
  private var circularProgress: some View {
    ZStack {
      ...
      Circle()
        ...
        .stroke(
          style: StrokeStyle(
            lineWidth: Constants.CircularProgress.lineWidth, lineCap: .round, lineJoin: .round)
        )
        ...
        .animation(
          ...
          value: folderConnectionHandler.uploadProgress)
    }
