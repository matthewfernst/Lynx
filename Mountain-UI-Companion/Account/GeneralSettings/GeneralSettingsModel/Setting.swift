...
extension Setting
{
    ...
    static let inviteKeySetting: Setting = .init(name: "Share Invite Key to Friend", iconImage: .init(systemName: "person.badge.key.fill"), backgroundColor: .inviteKeyGreen)
